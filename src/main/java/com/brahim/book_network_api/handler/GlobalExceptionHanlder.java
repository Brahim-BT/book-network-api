...
public class GlobalExceptionHanlder {
        ...
        public ResponseEntity<ExceptionResponse> handleException(EmailAlreadyExistsException exception) {
                return ResponseEntity.status(HttpStatus.CONFLICT).body(ExceptionResponse.builder()
                                .businessErrorCode(BusinessErrorCode.DUPLICATE_EMAIL.getCode())
                                .businessErrorDescription(BusinessErrorCode.DUPLICATE_EMAIL.getDescription())
                                .error(exception.getMessage()).build());
        }
